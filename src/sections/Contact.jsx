  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.send(
        ...
        to_email: 'awolowodaniel@yahoo.ie',
    ...
    <section className="c-space my-20" id="contact">
      <div className="relative min-h-screen flex items-center justify-center flex-col">
        ...
        <div className="contact-container">
          ...
          <p className="text-lg text-white-600 mt-3">Whether you're looking to build a new website, improve an existing platform, bring a project to life, or to work together, simply message me, and I'll get back to you shortly.</p>
          <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col space-y-7">
            ...
            <label className="space-y-3">
              ...
              <textarea name='message' value={form.message} onChange={handleChange} required rows={5} className="field-input" placeholder="Your Message" />
            </label>
